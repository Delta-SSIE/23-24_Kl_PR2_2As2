namespace _03_OOP3_07_Salesmen_tree
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //PrintSales(boss, "Benny", "MacSweeney");
        ...
        static void PrintSales(Salesman root, string name, string surname)
        {
            //když jsem na hledané osobě, vypiš
        ...
        static Salesman FindSalesmanStack(Salesman root, string name, string surname)
        {
            ...
            while(listToSearch.Count > 0) 
            {
                ...
                foreach(Salesman sub in person.Subordinates)
                {
